...
<div class="page-content bg-white">
    <!-- inner page banner -->
    <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(<?= SITE_URL ?>images/banner/bnr1.jpg);">
        <div class="container">
                    ...
                    <div class="col-lg-8">
                        <div class="job-info-box">
                            <h3 class="m-t0 m-b10 font-weight-700 title-head">
                                <a href="javascript:void(0);" class="text-secondry m-r30">Digital Marketing Executive</a>
                            </h3>
                            <ul class="job-info">
