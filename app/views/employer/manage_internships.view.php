						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx clearfix" >
								<div class="job-bx-title clearfix" style='border:0px;'>
									<!--<h5 class="font-weight-700 pull-left text-uppercase"><?= $text_title_Manage_internships?></h5>-->
									<h5 class="font-weight-700 text-uppercase"> <?= $text_title_Manage_internships?> </h5>
									<br>
									...
									<div class='row' style='width:100%;'>
										...
										<div class="btn-group float-right">
										  <a href='manage_internships?by=me'><button type="button" class="btn <?= $active1 ?>">My internships</button></a>
										  <a href='manage_internships?by=all'><button type="button" class="btn <?= $active2 ?>">All internships</button></a>
										</button>
										</div>
										</div>
									</div>
							...
							<div class="job-bx clearfix" style='margin-top:15px;'>
								<div class="job-bx-title clearfix">
									<!--<h5 class="font-weight-700 pull-left text-uppercase"><?= $text_title_Manage_internships?></h5>-->
									<h5 class="font-weight-700 pull-left text-uppercase"><?=$status?> internships (<span id='<?= $status?>_num'><?= $$num_indx ?></span>)</h5>
								...
								<table class="table-job-bx cv-manager company-manage-job">
									<thead>
										<tr>
											...
											<th><?= $text_title_internship_Title?> </th>
									...
									<?php 
										...
										<tr id='p_row_<?= $postID ?>'>
											...
											<td class="job-links">
												<a href="view_internship/<?= $post->id ?>" class="<?= $status?>_view_post" id="v_<?= $post->id ?>"                                                >
												<i class="fa fa-eye"></i></a>
												<a href='edit_internship/<?= $post->id ?>'><i  id="e_<?= $post->id ?>" class="fa fa-edit <?= $status?>_edit_post"></i></a>
								...
								<?php }else { ?>
								<h2 style='color:red'> no <?= $status ?> internships </h2>
								<?php } ?>
							</div>
							<!--  #draft job -->
