								...
								<div class="row">
									...
									<div class="col-lg-12 col-md-6">
										<div class="widget bg-white p-lr20 p-t20  widget_getintuch radius-sm">
											<h4 class="text-black font-weight-700 p-t10 m-b15">Job Details  	<a href="/employer/activejob/<?= $job->id ?>" class="site-button">Active this job</a> </h4>
											<ul>
												...
												<li><i class="ti-money"></i><strong class="font-weight-700 text-black">Salary</strong><span><?= $job->salary_from ?></span> - </span> <span> <?= $job->salary_to ?> </span> <?php if($job->salary_time_per == 1 ) echo 'monthly';else echo 'yearly'; ?> </span></li>
												<li><i class="ti-shield"></i><strong class="font-weight-700 text-black">Experience</strong><span><?= $job->exp_years ?></span> Year Experience</li>
												<li><i class="ti-shield"></i><strong class="font-weight-700 text-black">number of vacancies</strong><span><?= $job->num_vacancies ?></span> vacancies</li>
											</ul>
						...
						<div class="col-lg-8">
							<div class="job-info-box">
								<h3 class="m-t0 m-b10 font-weight-700 title-head">
									<a href="javascript:void(0);" class="text-secondry m-r30"><?php echo $job->title ?></a>
								</h3>
								<ul class="job-info">
									<li><strong>Education</strong> <?= $job->education_degree ?> </li>
