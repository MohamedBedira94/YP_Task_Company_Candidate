						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx clearfix">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 pull-left text-uppercase"><?= $text_title_Resume?></h5>
									<a href="company-manage-job.html" class="site-button right-arrow button-sm float-right"><?= $text_title_Back?></a>
								</div>
