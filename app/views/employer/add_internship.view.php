				...
				<div class="container">
					<div class="row">
						...
						<form method='post' action=''>
							<div class="Internship-bx submit-resume">
								<div class="Internship-bx-title clearfix">
									<h5 class="font-weight-700 pull-left text-uppercase"><?= $text_title_Post_New_Internship ?></h5>
									<a href="\employer" class="site-button right-arrow button-sm float-right"><?= $text_button_Back?></a>
								</div>
								<!--<h5><?= $text_title_Internship_Inof ?> </h5>-->
									<div class="row">
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
												<label><?= $text_lable_Internship_Title ?> </label>
												<input name='title' type="text" class="form-control" placeholder="<?= $text_Enter_Internship_Title ?>  ">
											</div>
										</div>
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
												<label><?= $text_lable_Internship_Location ?> </label>
										...
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												<label><?= $text_lable_Internship_Role ?></label>
										...
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												<label><?= $text_lable_Internship_Type ?> </label>
												<input name='type' type="text" class="form-control tags_input" value=""/>
											</div>
										</div>
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												<label><?= $text_lable_Internship_Describtion ?> </label>
												<span><? $text_p_write_your_Internship_summary_and_resposibilities?> </span>
												<textarea  name='Internship_description' class="form-control" rows="5" id="comment"></textarea>
											</div>
										</div>
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												<label><?= $text_lable_Internship_Requirements ?></label>
												<span><? $text_p_write_required_skills_and_expertise_desired_candidate?> </span>
												<textarea  name='Internship_requirements' class="form-control" rows="5" id="comment"></textarea>
											</div>
										</div>	
								...
								<div class="internship-bx submit-resume" style='margin-top:20px;'>
										<div class="internship-bx-title clearfix">
										...
										<a id="add_question" class="btn btn-info pull-right" style='background: #2e55fa;color:#fff;'><i class="fa fa-plus" aria-hidden="true"></i> <?= $text_add_Internship_Questions ?> </a>
										</div>
										
								</div>
								
								<div class="internship-bx submit-resume" style='margin-top:20px;'>
									<h2> internship Options </h2>
									<div class="form-group">
									...
									<div class="panel panel-default">
									  <div class="panel-heading">
										<h4 class="panel-title">
										  ...
										  <span class='case1' style='cursor: pointer;'>
											<i class="fas fa-plus" style='color:orange;'></i> Set advanced and detailed internship requirements.
										  </span>
										 ...
										 <span class='case1'>(Used to provide better candidate recommendations or filter applications. Important for technical internships)
										</span>
									  </div>
									  <div id="collapse3" class="panel-collapse collapse">
										<div class="panel-body">
											...
											candidate recommendations especially if this internship is for a technical position.
											</span>
											<div class="col-lg-12 col-md-12">
														...
														<div class="form-group row">
															...
															(i.e. internship seekers with excellent and very good grade will be preferred)</label>
															</div>
														</div>
													</div>
...
/*
	$(function(){
		<!-- tags_Related_Industry   tags_internship_Type -->
		var internship_roles = [
			'role1',
			'role2',
			'role3',
			'role4'
		...
		$(".tags_internship_Role").tagComplete({

			keylimit: 1,
			hide: false,
			freeInput : false,
			autocomplete: {
				data: internship_roles
			}
		});
